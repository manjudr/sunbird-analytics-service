...
class TestClientLogsAPIService extends BaseSpec {
  ...
  "Client Log API Service" should "validate the request" in {
    // did is null
    val INVALIDREQUEST1 = "{\"request\":{\"pdata\":{\"id\":\"contentPlayer\",\"ver\":\"1.0\",\"pid\":\"prod.sunbirded.app\"},\"context\":{\"dspec\":{\"os\":\"mac\",\"make\":\"\",\"mem\":0,\"idisk\":\"\",\"edisk\":\"\",\"scrn\":\"\",\"camera\":\"\",\"cpu\":\"\",\"sims\":0,\"uaspec\":{\"agent\":\"\",\"ver\":\"\",\"system\":\"\",\"platform\":\"\",\"raw\":\"\"}}},\"logs\":[{\"id\":\"13123-123123-12312-3123\",\"ts\":1560346371,\"log\":\"Exception in thread \\\"main\\\" java.lang.NullPointerException\\n        at com.example.myproject.Book.getTitle(Book.java:16)\\n        at com.example.myproject.Author.getBookTitles(Author.java:25)\\n        at com.example.myproject.Bootstrap.main(Bootstrap.java:14)\\n\"},{\"id\":\"13123-123123-12312-3123\",\"ts\":1560346371,\"log\":\"Exception in thread \\\"main\\\" java.lang.NullPointerException\\n        at com.example.myproject.Book.getTitle(Book.java:16)\\n        at com.example.myproject.Author.getBookTitles(Author.java:25)\\n        at com.example.myproject.Bootstrap.main(Bootstrap.java:14)\\n\"}]}}"
    ...
    val INVALIDREQUEST8 = "{\"request\":{\"context\":{\"did\":\"13123-13123-123123-1231231\"}, \"pdata\":{\"id\":\"in.ekstep\",\"pid\":\"prod.sunbird.app\"}, \"logs\":[]}}"
    ...
    val INVALIDREQUEST11 = "{\"request\":{\"context\":{\"did\":\"13123-13123-123123-1231231\"},\"pdata\":{\"id\":\"in.ekstep\",\"pid\":\"prod.sunbird.app\",\"ver\":\"1.0\"}}}"
