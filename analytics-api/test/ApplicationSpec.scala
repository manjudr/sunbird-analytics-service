...
class ApplicationSpec extends BaseSpec {
	...
	"Client Log API" should new WithApplication {
		"should return error response for invalid request" in {
			val request = """ {"request":{"context":{"pdata":{"id":"dev.sunbirded.org","ver":"1.0","pid":"contentPlayer"}},"edata":{"dspec":{"os":"","make":"","mem":0,"idisk":"","edisk":"","scrn":"","camera":"","cpu":"","sims":0,"uaspec":{"agent":"","ver":"","system":"","platform":"","raw":""}},"crashts":"1560346371","crash_logs":"Exception in thread \"main\" java.lang.NullPointerException\n        at com.example.myproject.Book.getTitle(Book.java:16)\n        at com.example.myproject.Author.getBookTitles(Author.java:25)\n        at com.example.myproject.Bootstrap.main(Bootstrap.java:14)\n"}}} """
		...
		"should return success response for valid request" in {
			val request = """ {"request":{"context":{"pdata":{"id":"dev.sunbirded.org","ver":"1.0","pid":"contentPlayer"},"did":"345345-345345-345345-345345"},"edata":{"dspec":{"os":"","make":"","mem":0,"idisk":"","edisk":"","scrn":"","camera":"","cpu":"","sims":0,"uaspec":{"agent":"","ver":"","system":"","platform":"","raw":""}},"crashts":"1560346371","crash_logs":"Exception in thread \"main\" java.lang.NullPointerException\n        at com.example.myproject.Book.getTitle(Book.java:16)\n        at com.example.myproject.Author.getBookTitles(Author.java:25)\n        at com.example.myproject.Bootstrap.main(Bootstrap.java:14)\n"}}} """
			post("/data/v1/client/logs", request)
			val response = post("/data/v1/client/logs", request)
			hasClientError(response)
